...
//2. Personal Message: Store a person’s name in a variable, and print a message to that person.
 ...
 var msg:string="nice to meat you. Would you like to collabore with us."
...
var name4:string="Stephen Hawking";
var msg2:string='“However difficult life may seem, there is always something you can do and succeed at.”';
...
var famous_person:string=" Stephen Hawking  ";
var message:string='“ However difficult life may seem, there is always something you can do and succeed at.”';
...
var fname5:string="Muhammad Asif";
...
// your favorite number. Print that message.
 ...
 var Num1:number= 51214;
 var msg9:string=`My favorite number is ${Num1}.`;
 console.log(msg9);
...
var names:string[]=["arfan","naveed", "zia","arslan","yasir", "mudassar"]
var i=0;
...
var cars:string[]=["Honda", "Toyota", "BMW"]
...
var guestNames:string[]=["arfan","naveed", "zia","arslan","yasir", "mudassar"];
for (let i = 0; i < guestNames.length; i++) {
        console.log("Dear",guestNames[i],",You are cordially invited to join me for dinner today.");
}
...
var guestNames:string[]=["arfan","naveed", "zia","arslan","yasir", "mudassar"];
for (let i = 0; i < guestNames.length; i++) {
    console.log(guestNames[i],",You are cordially invited to join me for dinner today.");
}
for (let i = 0; i < guestNames.length; i++) {
    guestNames.splice(2,1,"Shahid");
    console.log(guestNames[i],"join me for dinner today.");
}
...
const modifyGuest:number=guestNames.length;
console.log(modifyGuest);
for (let i = 0; i < guestNames.length; i++) {
    console.log("I have a dinner for you dear",guestNames[i]);
}
...
// • Sort to change your array so it’s stored in reverse alphabetical order. Print the list to show that its order has changed.
 ...
 var cityNames:string[]= ['Paris', 'Vienna', 'Berlin', 'London', 'Dublin'];
 console.log("Original=",cityNames);
let modifyArray=[...cityNames].sort();
...
var citiesNames1: string[] = ['Paris', 'Vienna', 'Berlin', 'London', 'Dublin'];
console.log("For index=5, the city name is",citiesNames1[5]);

for(let i=0; i<citiesNames1.length; i++){
  console.log("For index=",i,", the city name is",citiesNames1[i],".")
}
